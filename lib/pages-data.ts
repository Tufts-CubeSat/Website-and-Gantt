...
export const pagesData: Record<string, PageMetadata> = {
  ...
  "space-raccoon": createPageMetadata({
    id: "space-raccoon",
    title: "SPACE RACCOON",
    href: "/space-raccoon",
    ...
    keywords: ["space raccoon", "mission", "satellite", "specifications", "technical", "objectives", "launch", "payload", "design", "cubesat"],
    category: "Mission",
    priority: 10,
  }),
  "space-raccoon-timeline": createPageMetadata({
