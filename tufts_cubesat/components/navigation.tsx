...
export function Navigation() {
  ...
  return (
    <>
      ...
      <button
        className="fixed top-4 left-4 z-50 md:hidden p-2 text-black transition-transform duration-200 hover:scale-110 active:scale-95"
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-full w-64 bg-white z-40 shadow-2xl transition-transform duration-300 ease-out md:hidden ${
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex fixed left-0 top-0 h-full w-64 flex-col items-center justify-center bg-white">
